...
export const InputField = ({ value, defaultValue, onEdit, proto, autoFocus, invalid, style }: IInputFieldProps): JSX.Element => {
  ...
  return <View style={{ height: elementFormInputField.caption.place.bottom, display: 'flex', top: proto.place.top, left: proto.place.left, position: 'absolute', ...style }}>
    {invalid
