...
export const elementCardVaultClose = {
  name: 'elementCardVaultClose',
  ...
  layers: {
    ...
    status: new TextBox('status', 'sealed', {
      ...TextStyles.TITLERobotoSmallCapRegular12RedCenter,
      lineHeight: 14,
      textAlignVertical: 'top'
    }, { x: 5, y: 68, w: 150, h: 26, r: 5, b: 67 }),
    icon: new ImagePlacement('icon', ImageAsset.iconVaultBigClosed, { x: 52.5, w: 55, h: 62, r: 52.5, b: 99 })
  }
}
