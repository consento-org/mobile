...
export class ElementRelationSelectListCancelClass extends Component {
  icon: ImagePlacement
  avatarCut: Polygon
  iconLabel: Text
  relationID: Text
  ...
  state: Text
  constructor () {
    super('elementRelationSelectListCancel', 375, 100)
...
export const elementRelationSelectListCancel = new ElementRelationSelectListCancelClass()
