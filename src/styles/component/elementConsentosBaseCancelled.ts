...
export class ElementConsentosBaseCancelledClass extends Component {
  line: Polygon
  state: Text
  ...
  constructor () {
    super('elementConsentosBaseCancelled', 340, 114)
    this.line = new Polygon({ x: 122, y: 12, w: 96, h: 1 }, null, {
      fill: Color.darkGrey,
      thickness: 1,
      lineEnd: 'Butt'
    }, [], this)
    this.state = new Text('Revoked', TextStyles.H5RobotoRegular24GreyCenter, { x: 0, y: 30.5, w: 340, h: 36 }, this)
  }
}

export const elementConsentosBaseCancelled = new ElementConsentosBaseCancelledClass()
