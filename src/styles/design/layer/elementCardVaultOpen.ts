...
export const elementCardVaultOpen = {
  name: 'elementCardVaultOpen',
  ...
  layers: {
    ...
    status: new TextBox('status', 'open', {
      ...TextStyles.TITLERobotoSmallCapRegular12BlueCenter,
      lineHeight: 14,
      textAlignVertical: 'top'
    }, { x: 5, y: 68, w: 150, h: 26, r: 5, b: 67 }),
    icon: new ImagePlacement('icon', ImageAsset.iconVaultBigOpen, { x: 52.5, w: 55, h: 62, r: 52.5, b: 99 })
  }
}
