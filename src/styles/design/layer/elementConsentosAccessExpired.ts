...
export const elementConsentosAccessExpired = {
  name: 'elementConsentosAccessExpired',
  ...
  layers: {
    ...
    state: new LayerPlacement('state', elementConsentosBaseExpired, elementConsentosBaseExpired.layers, { y: 152.5, w: 340, h: 114, b: 13.5 }, ({ deleteButton }) => ({
