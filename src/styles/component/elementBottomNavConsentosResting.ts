...
export class elementBottomNavConsentosRestingClass extends Component {
  icon = new ImagePlacement(Asset.iconConsentoIdle, { x: 37, y: 8, w: 24, h: 24 })
  title = new Text('Consentos', TextStyles.SubtitleRobotoRegular13BlackCenter, { x: 0, y: 37, w: 98, h: 16 })
  constructor () {
