...
export const elementRelationSelectListUnselected = {
  name: 'elementRelationSelectListUnselected',
  place: forSize(375, 100),
  layers: {
    icon: new ImagePlacement('icon', ImageAsset.iconToggleUncheckedGrey, { x: 323, y: 38.5, w: 24, h: 24, r: 28, b: 37.5 }),
