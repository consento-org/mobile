...
export class ElementTextEditorClass extends Component {
  ...
  constructor () {
    ...
    this.save = new Text('Save', TextStyles.BodyRobotoRegular18BlueLeft, { x: 142, y: 41, w: 62, h: 24 }, this)
    this.close = new Text('Close', TextStyles.BodyRobotoRegular18BlueLeft, { x: 16, y: 41, w: 62, h: 24 }, this)
    ...
    this.saveSize = new Polygon({ x: 129.25, y: 0, w: 116.5, h: 65 }, '#da552f1c', null, [], this)
