...
export class elementCardVaultOpenClass extends Component {
  ...
  status = new Text('open', TextStyles.TITLERobotoSmallCapRegular12BlueCenter, { x: 5, y: 61, w: 150, h: 26 })
  icon = new AssetPlacement(Asset.iconVaultBigOpen, { x: 52.5, y: 0, w: 55, h: 62 })
  constructor () {
