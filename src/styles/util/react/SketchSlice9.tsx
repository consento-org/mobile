...
export const SketchSlice9 = forwardRef<View, ISketchSlice9Props>((props, ref): JSX.Element => {
  ...
  return <View {...props} style={StyleSheet.compose(styles.box, props.style)} ref={ref}>
