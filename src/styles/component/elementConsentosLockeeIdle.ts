...
export class ElementConsentosLockeeIdleClass extends Component {
  card = new Polygon({ x: 0, y: 68, w: 340, h: 310 }, Color.white, {
  ...
  lastAccess: Text
  outline = new Polygon({ x: 120, y: 6, w: 100, h: 100 }, Color.mediumGrey, null, [])
  mask = new Polygon({ x: 122, y: 8, w: 96, h: 96 }, '#d8d8d8ff', null, [])
  question: Text
  relationName: Text
  vaultName: Text
