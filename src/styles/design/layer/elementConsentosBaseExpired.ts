...
export const elementConsentosBaseExpired = {
  name: 'elementConsentosBaseExpired',
  ...
  layers: {
    ...
    state: new TextBox('state', 'expired', TextStyles.H5RobotoRegular24GreyCenter, { y: 30.5, w: 340, h: 36, b: 47.5 }),
