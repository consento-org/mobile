...
export class ElementCardVaultPendingClass extends Component {
  ...
  icon: ImagePlacement
  constructor () {
    super('elementCardVaultPending', 160, 161)
    ...
    this.status = new Text('pending', TextStyles.TITLERobotoSmallCapRegular12GreyCenter, { x: 5, y: 60, w: 150, h: 26 }, this)
    this.icon = new ImagePlacement(Asset.iconVaultBigPending, { x: 52.5, y: 0, w: 55, h: 62 }, this)
  }
}

export const elementCardVaultPending = new ElementCardVaultPendingClass()
